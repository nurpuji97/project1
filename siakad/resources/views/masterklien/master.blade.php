...
<head>
	...
	<link rel="stylesheet" href="{{asset('client/assets/vendor/chartist/css/chartist-custom.css')}}">
	<!-- MAIN CSS -->
...
<body>
	...
	<div id="wrapper">
		<!-- NAVBAR -->
		@include('masterklien.layout.navbar')
		<!-- END NAVBAR -->
		<!-- LEFT SIDEBAR -->
		@include('masterklien.layout.sidebar')
		<!-- END LEFT SIDEBAR -->
		<!-- MAIN -->
		@yield('content')
		<!-- END MAIN -->
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">Shared by <i class="fa fa-love"></i>Nur Pujiyanto
</p>
			</div>
		</footer>
	</div>
	...
	<script src="{{asset('client/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
	<script src="{{asset('client/assets/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js')}}"></script>
	<script src="{{asset('client/assets/vendor/chartist/js/chartist.min.js')}}"></script>
	<script src="{{asset('client/assets/scripts/klorofil-common.js')}}"></script>
