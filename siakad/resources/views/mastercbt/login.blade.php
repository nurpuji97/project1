				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" action="/postlogcbt" method="POST">
								{{csrf_field()}}
								<div class="form-group">
									<label for="signin-email" class="control-label sr-only">Name</label>
									<input name="name" type="text" class="form-control" id="signin-email" value="" placeholder="Name">
								</div>
								<div class="form-group">
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Computer Based Test</h1>
							<p>by The Nur Puji</p>
						</div>
					</div>
