						...
						<div class="panel-heading">
                          ...
                          <div align="justify">
                            ...
                            <div class="card-body">
                                ...
                                @if($kin->jenis_model_skor == "praktik_1")
                                <div class="card-body">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <form action="/addnilrekpra" name="ffrom" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            {{ csrf_field() }}
                                ...
                                @elseif($kin->jenis_model_skor == "praktik_2")
                                <div class="card-body">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <form action="/upaddnilrekpra" name="ffrom" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            {{ csrf_field() }}
                                            {{method_field('PUT')}}
                                ...
                                @elseif($kin->jenis_model_skor == "praktik_3")
                                <div class="card-body">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <form action="/upaddnilrekpra3" name="ffrom" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            {{ csrf_field() }}
                                            {{method_field('PUT')}}
                                ...
                                @else($kin->jenis_model_skor == "praktik_4")
                                <div class="card-body">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <form action="/upaddnilrekpra4" name="ffrom" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            {{ csrf_field() }}
                                            {{method_field('PUT')}}
