                   ...
                   <div class="panel">
                        ...
                        <div class="card-body">
                                <table class="table table-striped" >
                                    ...
                                    <tbody>
                                    @foreach($siswa->penilaiandiri as $hb)                         
                                        <tr>
            ...
            <div class="modal-body">                
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="/inputnilaidirisiswa" method="post" enctype="multipart/form-data" class="form-horizontal">
                        {{ csrf_field() }}
                        ...
                        {{$siswa->penilaiandiri->count()}} dari {{$nilaidiri->count()}} pertanyaan

                        @if( $siswa->penilaiandiri->count() == $nilaidiri->count() )
