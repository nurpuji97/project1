			...
			<div class="main-content">
				<div class="container-fluid">
                   ...
                   <div class="panel">
                        ...
                        <button class="btn btn-primary mb-1" type="button" data-toggle="modal" data-target="#largeModal">Penilaian Diri</button> </br>
                        <div class="card-body">
            ...
            <div class="modal-body">                
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="/inputnilaitemansiswa" method="post" enctype="multipart/form-data" class="form-horizontal">
                        {{ csrf_field() }}
                        ...
                        <div class="row form-group">
                            ...
                            @if($errors->any())
                                <div class="alert alert-danger">
                                    <ul>
                                        @foreach($errors->get('semester_id') as $message)
                                            <li>{{$message}}</li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="pernyataanteman_id" id="select" class="form-control">
                                    <option value="">Please select</option>
                                    @foreach($nilaiteman as $sk)
                        ...
                        <div class="row form-group">
                            ...
                            @if($errors->any())
                                <div class="alert alert-danger">
                                    <ul>
                                        @foreach($errors->get('pilihan') as $message)
                                            <li>{{$message}}</li>
                                        @endforeach
                                    </ul>
                                </div>
                        ...
                        {{$siswa->penilaianteman->count()}} dari {{$nilaiteman->count()}} pertanyaan

                        @if( $siswa->penilaianteman->count() == $nilaiteman->count() )
                        <div class="alert alert-info" role="alert">
							<i class="fa fa-info-circle"></i> Terima Kasih {{$siswa->nama}} Anda Telah Mengisi Penilaian Diri
						</div>
                        @endif
